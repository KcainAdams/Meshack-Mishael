...
class GameScreen(ttk.Tk):
    def __init__(self):
        ...
        self.hit_button = ttk.Button(self.bottom_frame, text="Hit", width=25,
                                    command=self.hit)
        self.stick_button = ttk.Button(self.bottom_frame, text="Stick", width=25,
                                      command=self.stick)

        self.play_again_button = ttk.Button(self.bottom_frame, text="Play Again",
                                           width=25, command=self.play_again)
        self.quit_button = ttk.Button(self.bottom_frame, text="Quit", width=25,
